...
function experimentInit() {
  ...
  text_7 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_7',
    text: 'After clicking, you will see letters "F" and "M" on your screen, and please click on either to identify the gender of the face you just saw (F: Female, M: Male). This will also start the next trial. \nNote that the face could be sometimes presented upside down. If you are unsure about the gender, please try your best to guess. \n\n(Press the spacebar to proceed)\n',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], height: 0.05,  wrapWidth: undefined, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
function Pause_1RoutineBegin(trials) {
  return function () {
    ...
    Pause_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
